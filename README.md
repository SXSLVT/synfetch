...
<div align="center">
<img width="915" height="372" alt="image" src="https://github.com/user-attachments/assets/16973f23-3a1f-47c7-94fe-390f2adb8bb4" />
...
They told me **bash** wasn't meant for speed... I took that personally. `synfetch` stands out to be fast, unique and minimal system fetch + monitor tool written entirely in pure **bash**.
...
You can use the [`install.sh`](./install.sh) script to update it whenever you want.
