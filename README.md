...
<img width="448" height="451" alt="image" src="https://github.com/user-attachments/assets/4e9955eb-f472-4846-9254-94f087659916" />
...
For `Nix` users, enable `flakes` and you can just run: 
